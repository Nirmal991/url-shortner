...
const DashboardLayout = () => {
  ...
  return (
    <div className="lg:px-14 sm:px-8 px-4 min-h-[calc(100vh-64px)]">
      {loader ? (
        // ✅ Use your custom loader if you have it, else simple text
        <p>Loading....</p>
      ) : error ? (
        ...
        <div className="lg:w-[90%] w-full mx-auto py-16">
          ...
          <div className="py-5 sm:text-end text-center">
            <button
              className="py-2 px-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-md cursor-pointer"
            ...
            {!isLoading && myShortenUrls.length === 0 ? (
              <div className="flex justify-center pt-16">
                <div className="flex gap-2 items-center justify-center py-6 sm:px-8 px-5 rounded-md  shadow-lg  bg-gray-50">
                  <h1 className="text-slate-800 font-sans sm:text-[18px] text-[14px] font-semibold mb-1 ">
