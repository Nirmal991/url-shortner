  ...
  return (
    <div className="flex justify-center items-center bg-white rounded-md">
      ...
      >
        ...
        <button
          className="w-32 py-2 my-3 rounded-md cursor-pointer font-semibold text-white bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 transition-colors"
          type="submit"
        >
