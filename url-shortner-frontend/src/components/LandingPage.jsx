      ...
      <div className="lg:flex-row flex-col    lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
        <div className=" flex-1">
          <motion.h1
            ...
            className="font-bold font-sans text-slate-800 md:text-5xl text-3xl md:leading-[55px] sm:leading-[45px] leading-10 lg:w-full md:w-[70%] w-full"
          >
          ...
          <div className="flex items-center gap-3">
            <motion.button
              ...
              className="bg-gradient-to-r from-blue-500 to-indigo-600 w-40 text-white rounded-md py-2 cursor-pointer"
            >
              Manage Links
            </motion.button>
            <motion.button
              ...
              transition={{ duration: 0.8 }}
              onClick={dashBoardNavigateHandler}
              className="border border-blue-500 w-40 text-blue-500 rounded-md py-2 cursor-pointer"
            >
              Create Short Link
            </motion.button>
          </div>
        ...
        <div className="flex-1 flex justify-centerw-full">
          <motion.img
            initial={{ opacity: 0 }}
            whileInView={{
              opacity: 1,
